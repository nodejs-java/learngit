...
<head>
	...
	<style type="text/css">@import url('resource/components/dtree/dtree.css');</style>
	<script type="text/javascript">var dtreeIconBasePath = "resource/components/dtree";</script>
	<script type="text/javascript"  src="resource/components/dtree/dtree.js"></script>
</head>
<body>
<script type="text/javascript"> 
var treeMenu = [
	{ level:1, name:"学生管理"},
	{ level:2, name:"学生列表", ico:"resource/images/icon_default.gif",link:"students/findAll"},
	{ level:1, name:"教师管理"},
	{ level:2, name:"教师列表", ico:"resource/images/icon_default.gif",link:"role_list.html"},
	{ level:1, name:"信息管理"},
	{ level:2, name:"新闻管理", ico:"resource/images/icon_default.gif",link:"news_list.html"},
	{ level:2, name:"公告管理", ico:"resource/images/icon_default.gif",link:"bulletin_list.html"},
	{ level:1, name:"系统邮件", ico:"resource/images/icon_default.gif"},
	{ level:1, name:"网络文件", ico:"resource/images/icon_default.gif",link:"complaint_list.html"}
];
</script>
<style>
* {
